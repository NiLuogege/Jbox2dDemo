...
package demo.com.jbox2ddemo.widget;
...
public class JboxImpl {
    ...
    public void creatBody(View view) {
        ...
        Shape shape = null;
        Boolean isCircle = (Boolean) view.getTag(R.id.jbox_cycle_view);
        ...
        view.setTag(R.id.jbox_body_view, body);
